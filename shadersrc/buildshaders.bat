...
if not exist "bin\ShaderCompile2.exe" goto NoShaderCompile
...
powershell -NoLogo -ExecutionPolicy Bypass -Command "%SrcDirBase%\bin\process_shaders.ps1 %DYNAMIC% -Version %SHVER% '%inputbase%.txt'"
